...
XT_NAMEQ:
 bal XT_DOLIST
 nop 
 .long XT_GTR,XT_RFETCH,XT_NAMEGTXT,XT_EQUALS,XT_RFETCH,XT_CELLMINUS,XT_FETCH,XT_LINKQ,XT_AND,XT_RGT,XT_NAMECOUNT,XT_DOLIT,0 ,XT_SCAN,XT_NIP,XT_ZEROEQUALS,XT_AND,XT_EXIT
...
XT_COLNAME:
 bal XT_DOLIST
 nop 
 .long XT_DUP,XT_QDODEFINE,XT_NIP,XT_ZEROEQUALS,XT_ZEROBRANCH,5 ,XT_DROP,XT_DOLIT,0 ,XT_EXIT,XT_DUP,XT_DOLIT,-32 ,XT_BOUNDS,XT_DODO,XT_DUP,XT_I,XT_NAMEQ,XT_ZEROBRANCH,5 ,XT_DROP,XT_I,XT_UNLOOP,XT_EXIT,XT_DOLIT,-1 ,XT_CELLS,XT_DOPLUSLOOP,-13 ,XT_UNLOOP,XT_DROP,XT_DOLIT,0 ,XT_EXIT
