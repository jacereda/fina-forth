...
XT_DICTZERO:
 ...
 .long 1b
1:
  .byte 0x7,0x64,0x69,0x63,0x74,0x74,0x6F,0x70
 .align 2
XT_DICTTOP:
 bl XT_DOVALUE
 .long 0xABADCAFE
...
XT_LASTNAME:
 ...
 .long 1b
1:
  .byte 0x6,0x6C,0x61,0x73,0x74,0x78,0x74
 .align 2
XT_LASTXT:
 bl XT_DOVALUE
 .long 0x0
...
_XT_MOVE:
 ...
 .long 1b
1:
  .byte 0x6,0x69,0x73,0x61,0x6D,0x65,0x3F
 .align 2
_XT_ISAMEQ:
...
_XT_FLOATGTFX:
 ...
 .long 1b
1:
  .byte 0x9,0x66,0x78,0x3E,0x64,0x6F,0x75,0x62,0x6C,0x65
 .align 2
_XT_FXGTDOUBLE:
 ...
 .long 1b
1:
  .byte 0x9,0x64,0x6F,0x75,0x62,0x6C,0x65,0x3E,0x66,0x78
 .align 2
_XT_DOUBLEGTFX:
...
_XT_FFFLOAT:
 ...
 .long 1b
1:
  .byte 0x8,0x66,0x66,0x64,0x6F,0x75,0x62,0x6C,0x65
 .align 2
_XT_FFDOUBLE:
...
XT_QDICT:
 bl XT_DOLIST
 .long XT_HERE,XT_DICTQ,XT_ZEROEQUALS,XT_DOQTHROW,0xFFFFFFF8,XT_EXIT
...
XT_PLACE:
 bl XT_DOLIST
 .long XT_OVER,XT_DOLIT,0xFF,XT_UGTEQUALS,XT_DOQTHROW,0xFFFFFFEE,XT_OVER,XT_GTR,XT_ROT,XT_OVER,XT_ONEPLUS,XT_RGT,XT_MOVE,XT_CSTORE,XT_EXIT
...
XT_LINKQ:
 ...
 .long 1b
1:
  .byte 0x7,0x63,0x6F,0x6C,0x6E,0x61,0x6D,0x65
 .align 2
XT_COLNAME:
 bl XT_DOLIST
 .long XT_DUP,XT_QDODEFINE,XT_NIP,XT_ZEROEQUALS,XT_ZEROBRANCH,0x14,XT_DROP,XT_DOLIT,0x0,XT_EXIT,XT_GTR,XT_RFETCH,XT_CELLMINUS,XT_DUP,XT_NAMEGTXT,XT_RFETCH,XT_EQUALS,XT_OVER,XT_CELLMINUS,XT_FETCH,XT_LINKQ,XT_AND,XT_ZEROBRANCH,0xFFFFFFD4,XT_RDROP,XT_EXIT

 .align 2
 .long 1b
1:
  .byte 0x8,0x70,0x72,0x69,0x6D,0x6E,0x61,0x6D,0x65
 .align 2
XT_PRIMNAME:
 bl XT_DOLIST
 .long XT_GTR,XT_XTOF,XT_COLD,XT_COLNAME,XT_CELLMINUS,XT_FETCH,XT_DUP,XT_NAMEGTXT,XT_RFETCH,XT_EQUALS,XT_ZEROBRANCH,0xFFFFFFE4,XT_RDROP,XT_EXIT
...
XT_MATCHQ:
 bl XT_DOLIST
 .long XT_DUP,XT_NAMECOUNT,XT_PARSED,XT_FETCH,XT_EQUALS,XT_ZEROBRANCH,0x30,XT_PARSED,XT_TWOFETCH,XT_ISAMEQ,XT_ZEROEQUALS,XT_ZEROBRANCH,0x10,XT_DUP,XT_DOTO,XT_FOUND,XT_BRANCH,0x8,XT_DROP,XT_EXIT
...
XT_FIMMED:
 bl XT_DOLIST
 .long XT_CFETCH,XT_DOLIT,0x40,XT_AND,XT_ZEROEQUALS,XT_TWOSTAR,XT_ONEPLUS,XT_EXIT
...
XT_SLASHFCOMPO:
 bl XT_DOLIST
 .long XT_CFETCH,XT_DOLIT,0x20,XT_AND,XT_ZEROEQUALS,XT_EXIT

 .align 2
 .long 1b
1:
  .byte 0x4,0x27,0x6E,0x66,0x61
 .align 2
XT_TICKNFA:
 bl XT_DOLIST
 .long XT_PARSEMINUSWORD,XT_NFA,XT_DUP,XT_ZEROEQUALS,XT_DOQTHROW,0xFFFFFFF3,XT_EXIT
...
XT_ACCEPT:
 bl XT_DOLIST
 .long XT_TWODUP,XT_BL,XT_FILL,XT_SPAN,XT_OFF,XT_EKEY,XT_KEYHANDLER,XT_DOLIT,0xA,XT_EQUALS,XT_ZEROBRANCH,0xFFFFFFE8,XT_TWODROP,XT_DOLIT,0xFFFFFFFF,XT_SPAN,XT_PLUSSTORE,XT_SPAN,XT_FETCH,XT_EXIT

 .align 2
 .long 1b
1:
  .byte 0x8,0x28,0x72,0x65,0x66,0x69,0x6C,0x6C,0x29
 .align 2
XT_LPARENREFILLRPAREN:
 bl XT_DOLIST
 .long XT_TIB,XT_DUP,XT_DOLIT,0x100,XT_ACCEPT,XT_SOURCEVAR,XT_TWOSTORE,XT_GTIN,XT_OFF,XT_DOLIT,0xFFFFFFFF,XT_EXIT
...
XT_GTNUMBER:
 ...
 .long 1b
1:
  .byte 0xA,0x73,0x3E,0x75,0x64,0x6E,0x75,0x6D,0x62,0x65,0x72
 .align 2
XT_SGTUDNUMBER:
 bl XT_DOLIST
 .long XT_DOLIT,0xFFFFFFFF,XT_DPL,XT_STORE,XT_DOLIT,0x0,XT_DOLIT,0x0,XT_TWOSWAP,XT_GTNUMBER,XT_DUP,XT_ZEROBRANCH,0x44,XT_OVER,XT_CFETCH,XT_DOLIT,0x2E,XT_LTGT,XT_DOQTHROW,0xFFFFFFF3,XT_DUP,XT_ONEMINUS,XT_DPL,XT_STORE,XT_DOLIT,0x1,XT_SLASHSTRING,XT_BRANCH,0xFFFFFFB4,XT_TWODROP,XT_EXIT

 .align 2
 .long 1b
1:
  .byte 0x9,0x73,0x3E,0x64,0x6E,0x75,0x6D,0x62,0x65,0x72
 .align 2
XT_SGTDNUMBER:
 bl XT_DOLIST
 .long XT_OVER,XT_CFETCH,XT_DOLIT,0x2D,XT_EQUALS,XT_GTR,XT_RFETCH,XT_NEGATE,XT_SLASHSTRING,XT_SGTUDNUMBER,XT_RGT,XT_ZEROBRANCH,0x8,XT_DNEGATE,XT_EXIT
...
XT_SGTUNUMBER:
 bl XT_DOLIST
 .long XT_SGTUDNUMBER,XT_DPL,XT_FETCH,XT_ZEROLT,XT_ZEROBRANCH,0x8,XT_DROP,XT_EXIT
...
XT_SGTNUMBER:
 bl XT_DOLIST
 .long XT_SGTDNUMBER,XT_DPL,XT_FETCH,XT_ZEROLT,XT_ZEROBRANCH,0x8,XT_DROP,XT_EXIT
...
XT_TWOLITERAL:
 ...
 .long 1b
1:
  .byte 0x6,0x64,0x6F,0x77,0x6F,0x72,0x64
 .align 2
XT_DOWORD:
 bl XT_DOLIST
 .long XT_DUP,XT_SLASHFCOMPO,XT_STATE,XT_FETCH,XT_OR,XT_ZEROEQUALS,XT_DOQTHROW,0xFFFFFFF2,XT_DUP,XT_NAMEGTXT,XT_SWAP,XT_FIMMED,XT_ZEROLT,XT_STATE,XT_FETCH,XT_AND,XT_ZEROBRANCH,0x10,XT_COMPILECOMMA,XT_BRANCH,0x8,XT_EXECUTE,XT_EXIT

 .align 2
 .long 1b
1:
  .byte 0x8,0x64,0x6F,0x6E,0x75,0x6D,0x62,0x65,0x72
 .align 2
XT_DONUMBER:
 bl XT_DOLIST
 .long XT_PARSED,XT_TWOFETCH,XT_SGTNUMBER,XT_STATE,XT_FETCH,XT_ZEROBRANCH,0x28,XT_DPL,XT_FETCH,XT_ZEROLT,XT_ZEROBRANCH,0x10,XT_LITERAL,XT_BRANCH,0x8,XT_TWOLITERAL,XT_EXIT

 .align 2
 .long 1b
1:
  .byte 0xB,0x28,0x69,0x6E,0x74,0x65,0x72,0x70,0x72,0x65,0x74,0x29
 .align 2
XT_LPARENINTERPRETRPAREN:
 bl XT_DOLIST
 .long XT_DEPTH,XT_ZEROLT,XT_DOQTHROW,0xFFFFFFFC,XT_PARSEMINUSWORD,XT_DUP,XT_ZEROBRANCH,0x2C,XT_NFA,XT_QDUP,XT_ZEROBRANCH,0x10,XT_DOWORD,XT_BRANCH,0x8,XT_DONUMBER,XT_BRANCH,0xFFFFFFBC,XT_TWODROP,XT_EXIT
...
XT_QUIT:
 bl XT_DOLIST
 .long XT_RPZERO,XT_FETCH,XT_RPSTORE,XT_DOLIT,0x0,XT_DOTO,XT_SOURCEMINUSID,XT_LBRACKET,XT_REFILL,XT_DROP,XT_XTOF,XT_INTERPRET,XT_CATCH,XT_DOTERRORSTORE,XT_QDUP,XT_ZEROEQUALS,XT_ZEROBRANCH,0x24,XT_STATE,XT_FETCH,XT_ZEROEQUALS,XT_ZEROBRANCH,0x8,XT_DOTPROMPT,XT_BRANCH,0xFFFFFFBC,XT_DOTERROR,XT_SPZERO,XT_FETCH,XT_SPSTORE,XT_BRANCH,0xFFFFFF84,XT_EXIT
...
XT_COLONNONAME:
 bl XT_DOLIST
 .long XT_HASNAMEQ,XT_OFF,XT_RBRACKET,XT_HERE,XT_DOTO,XT_LASTXT,XT_XTOF,XT_DOLIST,XT_XTCOMMA,XT_DUP,XT_DOLIT,0xFFFFFFFF,XT_EXIT
...
XT_SEMI:
 bl XT_DOLIST
 .long XT_NIP,XT_ONEPLUS,XT_DOQTHROW,0xFFFFFFEA,XT_REVEAL,XT_LPARENCOMPILERPAREN,XT_EXIT,XT_LBRACKET,XT_EXIT
...
XT_POSTPONE:
 bl XT_DOLIST
 .long XT_TICKNFA,XT_DUP,XT_NAMEGTXT,XT_SWAP,XT_FIMMED,XT_ZEROLT,XT_ZEROBRANCH,0x14,XT_LPARENCOMPILERPAREN,XT_LPARENCOMPILERPAREN,XT_COMMA,XT_EXIT,XT_COMPILECOMMA,XT_EXIT
...
XT_SCOMMA:
 ...
 .long 1b
1:
  .byte 0x4,0x28,0x69,0x73,0x29
 .align 2
XT_LPARENISRPAREN:
 bl XT_DOLIST
 .long XT_FETCHRPLUS,XT_DOLIT,0x8,XT_PLUS,XT_STORE,XT_EXIT
