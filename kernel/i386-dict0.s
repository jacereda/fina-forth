...
XT_TICKDOTERROR:
 ...
 .long 1b
1:
  .byte 0x8,0x27,0x2E,0x65,0x72,0x72,0x6F,0x72,0x21
 .p2align 2
XT_TICKDOTERRORSTORE:
 nop
 nop
 nop
 call XT_DOVAR
...
XT_QUIT:
 ...
 nop
 call XT_DOLIST
 .long XT_RPZERO,XT_FETCH,XT_RPSTORE,XT_DOLIT,0x0,XT_DOTO,XT_SOURCEMINUSID,XT_BAL,XT_OFF,XT_LBRACKET,XT_REFILL,XT_DROP,XT_XTOF,XT_INTERPRET,XT_CATCH,XT_TICKDOTERRORSTORE,XT_FETCHEXECUTE,XT_QDUP,XT_ZEROEQUALS,XT_ZEROBRANCH,0x24,XT_STATE,XT_FETCH,XT_ZEROEQUALS,XT_ZEROBRANCH,0x8,XT_DOTPROMPT,XT_BRANCH,0xFFFFFFB8,XT_TICKDOTERROR,XT_FETCHEXECUTE,XT_SPZERO,XT_FETCH,XT_SPSTORE,XT_BRANCH,0xFFFFFF74,XT_EXIT
